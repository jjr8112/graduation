...
<template>
  <el-container>
    ...
    <el-header>
      ...
      <el-button type="primary" style="margin-right; 5px"  @click="exprotExcel">导出</el-button>
    </el-header>
...
import XLSX from "xlsx"
  ...
  export default {
    ...
    methods: {
      ...
      exprotExcel(){
        var table = XLSX.utils.table_to_book(document.querySelector("#out-table"));
        var tb = XLSX.write(table, {
          bookType: "xlsx",
          bookSST: true,
          type: "array"
        });
        try {
          ...
          if(typeof console !== "undefined") console.log(e,tb);
        }
        return tb;
      },
      //添加用户
