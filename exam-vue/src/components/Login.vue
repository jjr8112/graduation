        ...
        <div>
          <el-form :model="loginForm" :rules="loginFormRules" ref="loginForm" :status-icon="true" label-width="100px">
            <el-form-item prop="username">
              <el-input prefix-icon="el-icon-user" v-model="loginForm.username" placeholder="账号/学号"></el-input>
            </el-form-item>
            ...
            <!-- <el-form-item prop="code">
              ...
              <img src="http://192.168.1.102:8888//util/getCodeImg" @click="changeCode" id="code"
            ...
            <el-form-item>
              ...
              <el-button type="warning" @click="toRegisterPage" icon="el-icon el-icon-circle-plus">注册</el-button>
            </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //   code.src = 'http://192.168.1.102:8888/util/getCodeImg?id=' + Math.random()
