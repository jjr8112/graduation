...
//[{"topMenuName":"产品介绍","topIcon":"el-icon-odometer","url":"/dashboard"},{"topMenuName":"考试管理","topIcon":"el-icon-bangzhu","submenu":[{"name":"题库管理","icon":"el-icon-aim","url":"/questionBankMange"},{"name":"试题管理","icon":"el-icon-news","url":"/questionManage"},{"name":"考试管理","icon":"el-icon-tickets","url":"/examManage"},{"name":"阅卷管理","icon":"el-icon-view","url":"/markManage"}]},{"topMenuName":"考试统计","topIcon":"el-icon-pie-chart","submenu":[{"name":"统计总览","icon":"el-icon-data-line","url":"/staticOverview"}]}]