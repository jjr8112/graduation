...
public class User implements Serializable {
    ...
    @ApiModelProperty(value = "真实姓名", example = "超级管理员")
    ...
    @ApiModelProperty(value = "上次登录时间",example = "2022-03-15 12:20:00")
    private String lastLoginDate;

    @ApiModelProperty(value = "上次登录IP", example = "192.168.1.107")
    private String lastLoginIp;

    @ApiModelProperty(value = "上次登录MAC", example = "80:fa:5b:57:b6:3c")
