...
import com.jjr8112.Util.CertificateUtil.ContentStyle;
import com.jjr8112.Util.CertificateUtil.DateTimeUtil;
import com.jjr8112.Util.CertificateUtil.PDFUtil;
import com.jjr8112.Util.RedisUtil;
import com.jjr8112.entity.ExamRecord;
import com.jjr8112.entity.Notice;
import com.jjr8112.entity.User;
import com.jjr8112.service.impl.*;
...
public class StudentController {
    ...
    public void getCertificate(HttpServletResponse response, @RequestParam(name = "examName") String examName,
        ...
        // 获取发放证书的项目Logo
        String logo = Objects.requireNonNull(PDFUtil.class.getClassLoader().getResource("static/images/sxu.png")).getPath();
...
//        String pdfFilePath = "/wzz/nginx_static_resources/templateCertificate.pdf";
        ...
        pdfUtil.openDocument(pdfFilePath)
                ...
                .addContent("Power By SXU", 360, 495, style2);
        // 结束截取字符串的索引
        int end = 0;
        // 证书内容分行,防止超出证书边缘
