package com.jjr8112.controller;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.conditions.update.UpdateWrapper;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.jjr8112.Util.*;
import com.jjr8112.entity.User;
import com.jjr8112.entity.UserRole;
import com.jjr8112.mapper.UserMapper;
import com.jjr8112.service.impl.ExamRecordServiceImpl;
import com.jjr8112.service.impl.UserRoleServiceImpl;
import com.jjr8112.service.impl.UserServiceImpl;
import com.jjr8112.vo.CommonResult;
...
public class CommonController {
    ...
    public CommonResult<String> Register(@RequestBody User user) throws NoSuchAlgorithmException {
        ...
        //发放token令牌
        String token = TokenUtils.createToken(new TokenVo("1", user.getUsername(), user.getTrueName(), newPwd));
    ...
    public CommonResult<String> login(@RequestParam(value = "username") String username,
        ...
        if (user != null) {
            ...
            if (newPwd.equals(user.getPassword()) && user.getStatus() == 1) {
                //发放token令牌
                String token = TokenUtils.createToken(new TokenVo(user.getRoleId() + "", user.getUsername(), user.getTrueName(), newPwd));

                UpdateWrapper<User> updateWrapper = new UpdateWrapper<>();
                updateWrapper.eq("username",username);
                User update = new User();
                update.setLastLoginDate(DateUtil.formatDateTime());
                update.setLastLoginIp(IpUtil.getIpAddr(httpServletRequest));
                System.out.println(update.getLastLoginIp());
                //System.out.println(System.getProperty("os.name").startsWith("Windows"));
                //String s = httpServletRequest.getHeader();
                update.setLastLoginMac(MAC3Util.getMACAddress(update.getLastLoginIp()));
                System.out.println(update.getLastLoginMac());
