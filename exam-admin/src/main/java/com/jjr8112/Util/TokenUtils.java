...
public class TokenUtils {//过期时间
    ...
    //私钥
    private static final String TOKEN_SECRET = "this is a token";
    ...
    public static TokenVo verifyToken(String token) {
        try {
            ...
            return new TokenVo(roleId, username, truename, password);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static void main(String[] args) {
        String token = TokenUtils.createToken(new TokenVo("3","test","admin","9499273223c7aca5949e3055eaa57f6f"));
